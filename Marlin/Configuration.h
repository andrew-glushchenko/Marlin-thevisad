...
#define STRING_CONFIG_H_AUTHOR "(FOLGERTECH, Kossel)" // Who made the changes. ("Blomker" only edited the parametric values in the sketch. Author name is maintain as jcrocholl to indicate source of this sketch, and credit to where it is due)
...
#define CUSTOM_MACHINE_NAME "Folgertech"
...
#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -3.3  // -below (always!)
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 256.5
...
#define DEFAULT_MAX_FEEDRATE          {300, 300, 300, 25}    // {500, 500, 500, 25} (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3000,3000,3000,1000}    // {9000,9000,9000,10000} X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 5,120} // {0,0, 0,0, 70,0} X,Y,Z Axis Extend and Retract angles
